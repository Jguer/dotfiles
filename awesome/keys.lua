...
function hotkeys:init(args)
  ...
  self.keys.root =
    ...
    -- ),
    awful.key({modkey}, "l", focus_switch_byd("right"), {description = "focus next by index", group = "client"}),
    awful.key({modkey}, "h", focus_switch_byd("left"), {description = "focus previous by index", group = "client"}),
    awful.key({modkey}, "k", focus_switch_byd("up"), {description = "focus next by index", group = "client"}),
    awful.key({modkey}, "j", focus_switch_byd("down"), {description = "focus previous by index", group = "client"}),
    -- Layout manipulation
    awful.key(
      {modkey, "Shift"},
      "j",
    ...
    awful.key({modkey}, "Tab", focus_to_previous, {description = "go back", group = "client"}),
    -- Standard program
    ...
    awful.key({modkey, "Control"}, "n", restore_client, {description = "restore minimized", group = "client"}),
    -- Volume and Music
    awful.key(
      {},
    ...
    awful.key(
      ...
      function()
        awful.spawn(
          "rofi -combi-modi window,drun,ssh -theme " .. beautiful.themes_path .. "rofi.rasi" .. " -show combi"
        )
      end,
